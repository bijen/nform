...
class __TwigTemplate_cd7b02a509921acc4841bf0a539abc75bfe4e16249bf5a03654aa378a7c2e8d3 extends Twig_Template
{
    ...
    ";
        ...
        // line 102
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "WebProfilerBundle:Collector:config.html.twig", 102)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? $this->getContext($context, "profiler_url")))));
    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "WebProfilerBundle:Collector:config.html.twig", "/Applications/MAMP/htdocs/bijen/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/config.html.twig");
    }
}
