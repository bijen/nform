...
class __TwigTemplate_aef7f72b0373ca7e158f32dead46af708b4dda2d51f020082791d66e46ffdeeb extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", array()) || $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", array()))) {
            ...
            // line 14
            echo "            ";
            $context["error_count"] = ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", array()) + $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", array()));
            // line 15
        ...
        ";
            ...
            // line 31
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "WebProfilerBundle:Collector:logger.html.twig", 31)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? $this->getContext($context, "profiler_url")))));
            // line 32
            echo "    ";
        }
    }
...
{% macro display_message(log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "WebProfilerBundle:Collector:logger.html.twig", "/Applications/MAMP/htdocs/bijen/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
