...
class __TwigTemplate_48eaa6325a0ed6e14ed753368fc33f1baeec4bda62aac70a4cc6ed7aaeb2ce38 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        ";
        // line 9
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "email", array()), 'row');
        echo "
        ";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "message", array()), 'row');
        echo "
...
{% endblock %}
", "AcmeDemoBundle:Demo:contact.html.twig", "/Applications/MAMP/htdocs/bijen/src/Acme/DemoBundle/Resources/views/Demo/contact.html.twig");
    }
}
