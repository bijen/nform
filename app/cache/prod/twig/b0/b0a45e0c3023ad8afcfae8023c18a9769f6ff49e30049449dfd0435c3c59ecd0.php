...
class __TwigTemplate_e3c4fe38bd35772baa5fd23f96bbb85492649a8cce3958f29a90ecd27a29c28b extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate((($this->getAttribute($this->getAttribute(($context["app"] ?? null), "request", array()), "isXmlHttpRequest", array())) ? ("WebProfilerBundle:Profiler:ajax_layout.html.twig") : ("WebProfilerBundle:Profiler:layout.html.twig")), "DoctrineBundle:Collector:db.html.twig", 1);
    }
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        // line 6
        if ((50 < $this->getAttribute(($context["collector"] ?? null), "querycount", array()))) {
        ...
        // line 25
        echo ((($this->getAttribute(($context["collector"] ?? null), "invalidEntityCount", array()) > 0)) ? ("red") : ("green"));
        echo "\">";
    ...
    ";
        ...
        // line 28
        echo "    ";
        $this->loadTemplate("WebProfilerBundle:Profiler:toolbar_item.html.twig", "DoctrineBundle:Collector:db.html.twig", 28)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? null))));
    }
...
($context["token"] ?? null), "panel" => "db", "connectionName" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 47
($context["app"] ?? null), "request", array()), "query", array()), "get", array(0 => "connection"), "method"), "query" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 48
($context["app"] ?? null), "request", array()), "query", array()), "get", array(0 => "query"), "method"))));
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "connections", array())) {
            // line 110
            echo "        ";
            $this->loadTemplate("WebProfilerBundle:Profiler:table.html.twig", "DoctrineBundle:Collector:db.html.twig", 110)->display(array("data" => $this->getAttribute(($context["collector"] ?? null), "connections", array())));
            // line 111
            echo "    ";
        } else {
            // line 112
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "managers", array())) {
            // line 120
            echo "        ";
            $this->loadTemplate("WebProfilerBundle:Profiler:table.html.twig", "DoctrineBundle:Collector:db.html.twig", 120)->display(array("data" => $this->getAttribute(($context["collector"] ?? null), "managers", array())));
            // line 121
            echo "    ";
        } else {
            // line 122
...
";
    ...
    {
        return new Twig_Source("", "DoctrineBundle:Collector:db.html.twig", "/Applications/MAMP/htdocs/bijen/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views/Collector/db.html.twig");
    }
}
