...
class __TwigTemplate_b8c9df068f8d4b83d665cfde1a2ed9a41455237e5dd332d33fd3bf9f0a90a320 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(array("logs" => $this->getAttribute(($context["logger"] ?? null), "logs", array())));
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(array("exception" => ($context["exception"] ?? null)));
        // line 92
        echo "
...
";
    ...
    {
        return new Twig_Source("", "TwigBundle:Exception:exception.html.twig", "/Applications/MAMP/htdocs/bijen/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
