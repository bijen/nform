...
class __TwigTemplate_c3e2a186924f8728d500df0c3336771814f29b3e266a916cfe66d6aa653d8343 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "tokenClass", array())) {
            // line 5
            echo "        ";
            $context["color_code"] = ((($this->getAttribute(($context["collector"] ?? null), "enabled", array()) && $this->getAttribute(($context["collector"] ?? null), "authenticated", array()))) ? ("green") : ("yellow"));
            // line 6
            echo "        ";
            $context["authentication_color_code"] = ((($this->getAttribute(($context["collector"] ?? null), "enabled", array()) && $this->getAttribute(($context["collector"] ?? null), "authenticated", array()))) ? ("green") : ("red"));
            // line 7
            echo "        ";
            $context["authentication_color_text"] = ((($this->getAttribute(($context["collector"] ?? null), "enabled", array()) && $this->getAttribute(($context["collector"] ?? null), "authenticated", array()))) ? ("Yes") : ("No"));
            // line 8
            echo "    ";
        } else {
            // line 9
            echo "        ";
            $context["color_code"] = (($this->getAttribute(($context["collector"] ?? null), "enabled", array())) ? ("red") : ("black"));
            // line 10
            echo "    ";
        }
        // line 11
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "tokenClass", array())) {
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span class=\"sf-toolbar-status sf-toolbar-status-";
            // line 19
            echo twig_escape_filter($this->env, ($context["authentication_color_code"] ?? null), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, ($context["authentication_color_text"] ?? null), "html", null, true);
            echo "</span>
            </div>
            ";
            // line 21
        ...
        ";
        // line 36
        if ($this->getAttribute(($context["collector"] ?? null), "user", array())) {
        ...
        // line 38
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "SecurityBundle:Collector:security.html.twig", 38)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? null))));
    }
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "tokenClass", array())) {
            ...
            if ($this->getAttribute(($context["collector"] ?? null), "authenticated", array())) {
                ...
                // line 62
                echo "                        no ";
                if ( !twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "roles", array()))) {
            ...
            <tr>
                ...
                <td>";
            // line 68
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\YamlExtension')->encode($this->getAttribute(($context["collector"] ?? null), "roles", array())), "html", null, true);
            echo "</td>
            </tr>
            ";
            // line 70
...
($context["collector"] ?? null), "enabled", array())) {
    ...
    {
        return new Twig_Source("", "SecurityBundle:Collector:security.html.twig", "/Applications/MAMP/htdocs/bijen/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
